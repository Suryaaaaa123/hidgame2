...
{
    public class WBCharacterRagDollSetUp : ScriptableWizard
    {        
        public bool AutoDetectBones;
        ...
        [MenuItem("WeirdBrothers/Charcater Create/Ragdoll Creator", false, 2000)]
        static void CreateWizard()
        {
            ScriptableWizard.DisplayWizard<WBCharacterRagDollSetUp>("Create Ragdoll");
        }
        ...
        void GetHumanBones()
        {
            ...
            {
                Debug.LogError("can not setup bones automatically on selected character");
            }
        }
